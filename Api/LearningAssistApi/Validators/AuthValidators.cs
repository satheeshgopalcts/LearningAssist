    ...
    public class RegisterDtoValidator : AbstractValidator<RegisterDto>
    {
        public RegisterDtoValidator()
        {
            ...
            RuleFor(x => x.DateOfBirth)
                ...
                .Must(dob => dob.HasValue && BeAtLeast13YearsOld(dob.Value)).WithMessage("User must be at least 13 years old")
                .Must(dob => dob.HasValue && BeRealistic(dob.Value)).WithMessage("Date of birth must be realistic");
